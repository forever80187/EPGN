...
class Data:
    def __init__(self):
        ...
        self.domain_train_text, self.domain_test_text = [], []
        ...
        self.domain_train_idx, self.domain_test_idx = [], []
        ...
        self.label_alphabet_domain = Alphabet('label', True)
        ...
        self.label_alphabet_domain_size = 0
    ...
    def build_language_model_alphabet(self, lm_1_file=None, lm_2_file=None):
        for line in open(lm_1_file).readlines():
            ...
            for word in pairs:
                ...
                self.label_alphabet_domain.add('source')
    ...
    def build_alphabet(self, ner_1_file, ner_2_file, mode):
        ...
        for line in open(ner_2_file, 'r').readlines():
            if len(line) > 2:
                ...
                self.label_alphabet_domain.add('target')
        ...
        self.label_alphabet_domain_size = self.label_alphabet_domain.size()
    ...
    def fix_alphabet(self):
        ...
        self.label_alphabet_domain.close()
    ...
    def generate_instance(self):
        ...
        self.domain_train_text, self.domain_train_idx, self.domain_test_text, self.domain_test_idx =\
            read_domain_instance(self.supervised_lm_1_train, self.supervised_ner_2_train, self.supervised_ner_2_test,
                                 self.label_alphabet_domain, self.word_alphabet, self.number_normalized, self.MAX_SENTENCE_LENGTH)
