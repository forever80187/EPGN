...
class ParamGenerator(Module):
    ...
    def __init__(self, input_size, hidden_size, task_emb_size, layer_num=1,
        ...
        self.W_task = Parameter(torch.Tensor(w_task_roll_num, w_task_col_num))
        self.reset_param()
    ...
    def forward(self, task_emb):
        ...
        param_matrix = torch.mm(task_emb, self.W_task)
...
class LSTMParamGenerator(Module):
    ...
    def __init__(self, input_size, hidden_size, data):
        ...
        self.cpg_ = ParamGenerator(input_size, hidden_size, task_emb_size, 
